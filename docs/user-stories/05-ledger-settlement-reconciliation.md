...
Priority: `P1`
Notes: Deferred from the Venue Owner Financial Close completion slice. Do not
update historical Ledger records.
...
Priority: `P1`
Notes: Deferred from the Venue Owner Financial Close completion slice.
Customer invoices are not generated by GDS.
